...
export const MuiAwesomeTableRoot = styled(Box,{
    name: 'MuiAwesomeTable', // The component name
    ...
    return (
        <MuiAwesomeTableRoot {...root}>
            <Grid container spacing={2} justifyContent="center" flexDirection="row">
                ...
                <Grid item xs={12} sm={12}>
                    <Paper className="MuiAwesomeTablePaper-root" sx={{ width: '100%', mb: 2 }}>
                        <TableContainer>
